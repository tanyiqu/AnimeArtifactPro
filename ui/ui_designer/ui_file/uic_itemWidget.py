...
class Ui_item(object):
    def setupUi(self, item):
        ...
        item.resize(190, 290)
        item.setMinimumSize(QtCore.QSize(190, 290))
        item.setMaximumSize(QtCore.QSize(190, 290))
        ...
        self.widget.setMinimumSize(QtCore.QSize(190, 290))
        self.widget.setMaximumSize(QtCore.QSize(190, 290))
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.lblTitle.setMinimumSize(QtCore.QSize(190, 28))
        self.lblTitle.setMaximumSize(QtCore.QSize(190, 28))
        self.lblTitle.setStyleSheet("font: 11pt \"微软雅黑\";\n"
"padding-left:5px;\n"
"border: 0px;\n"
"color: #ffffff;")
        self.lblTitle.setObjectName("lblTitle")
        self.gridLayout_2.addWidget(self.lblTitle, 3, 0, 1, 1)
        self.lblLatest = QtWidgets.QLabel(self.widget)
        self.lblLatest.setMinimumSize(QtCore.QSize(190, 28))
        self.lblLatest.setMaximumSize(QtCore.QSize(190, 28))
